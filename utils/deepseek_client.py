...
class DeepSeekClient:
    def __init__(self):
        ...
        if not self.api_key:
            print("❌ Error: OPENROUTER_API_KEY no encontrada en el entorno (.env).")
            self.client = None
            return
        ...
        try:
            ...
            print(f"✅ Cliente DeepSeek (vía OpenRouter Free) configurado (Key: ****{last_digits})")
    ...
    def chat(self, prompt, system=""):
        ...
        try:
            ...
            if "402" in str(e):
                return f"❌ Error 402: Saldo insuficiente. Por favor, recarga tu cuenta en platform.deepseek.com o verifica tus créditos en OpenRouter."
