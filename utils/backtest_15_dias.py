...
import time
import os
from automation_deepseek_r1 import ejecutar_analisis_rendimiento
...
if __name__ == "__main__":
    ...
    if not df_res.empty:
        ...
        # Guardar resultados para que la IA los procese (Regla 8)
        path_json = os.path.join("data", "backtesting_results.json")
        df_res.to_json(path_json, orient="records", date_format="iso", indent=4)
        print(f"✅ Resultados guardados en {path_json}")
        ...
        # --- AUTOMATIZACIÓN ---
        print("\n🤖 Iniciando análisis automático de IA...")
